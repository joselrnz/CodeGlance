...
def test_overview_layer_cards_and_drilldown():
    ...
    html = render_interactive(_sample_graph())
    for marker in ("drawOverview", "drawFolders", "FLL", "nodeWorldPos", "drawFolderFileFrame", "folderHasChildren", "folderBreadcrumbHTML", "goFolderParent", "enterNodeFolder", "fileParentPrefix", "folderNav", "folder-nav-on", "updateFolderNav", "Layer root", "↑ Up one", "crumb-full", "Path: ", "↑ Up", "Open a smaller folder first", "open a folder to see files", "setView", "openLayer", "pickLayer", "updateCrumb"):
