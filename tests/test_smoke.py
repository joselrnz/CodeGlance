...
def test_overview_layer_cards_and_drilldown():
    ...
    html = render_interactive(_sample_graph())
    for marker in ("drawOverview", "drawFolders", "FLL", "nodeWorldPos", "drawFolderFileFrame", "folderHasChildren", "Open a smaller folder first", "open a folder to see files", "setView", "openLayer", "pickLayer", "updateCrumb"):
