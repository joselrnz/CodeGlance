...
`.codeglance/.codeglanceignore`. Good enough for excluding the usual noise; not a full
...
DEFAULT_IGNORE_DIRS = {
    ...
    ".idea", ".vscode", ".gradle", ".terraform", ".codeglance", ".codescape",
...
def build_matcher(root: Path) -> IgnoreMatcher:
    ...
    patterns += _read_patterns(root / ".codeglance" / ".codeglanceignore")
