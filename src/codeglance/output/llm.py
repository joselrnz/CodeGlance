    ...
    return {
        ...
        "artifactContracts": [
            ...
            },
            {
                ...
                "tier": 4,
                "audience": "tool",
                "contains": ["project", "nodes", "edges", "layers", "tour", "domains", "flows", "processes"],
        ...
        "knowledgeGraphSchema": {
            ...
            "domains": {
                "key": "stable business capability id",
                "name": "human-readable business capability name",
                "nodeIds": "evidence-backed graph nodes in the domain",
                "evidence": "path/summary signals used to infer this domain",
                "confidence": "0-1 heuristic confidence",
            },
            "flows": {
                "id": "stable flow id",
                "name": "human-readable business or technical flow name",
                "domainKey": "primary domain key",
                "steps": "ordered process steps with file and role evidence",
                "nodeIds": "graph nodes participating in this flow",
                "evidence": "signals used to infer this flow",
                "confidence": "0-1 heuristic confidence",
            },
            "processes": "Alias of flows for tools and agents that use process terminology.",
            "processSteps": {
                "order": "step order inside the flow",
                "label": "human-readable step label",
                "domainKey": "domain owning the step",
                "nodeId": "graph node backing the step",
                "filePath": "repo-relative source file",
                "role": "controller/api/service/domain/repository/file/etc.",
                "evidence": "source summary or path signal",
                "confidence": "0-1 heuristic confidence",
            },
        },
