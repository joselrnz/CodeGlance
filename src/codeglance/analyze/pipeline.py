...
from . import ts_core as ts
from . import imports as imp
from .languages.python import _ModuleIndex, _python_extract, _resolve_py_import
...
# Python symbol extraction + import resolution live in languages/python.py;
# cross-language import resolution lives in imports.py.
